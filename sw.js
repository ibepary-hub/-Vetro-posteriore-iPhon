...
const SHELL=["./","./index.html","./style.css?v=67","./app.js?v=67","./manifest.json?v=67","./beparytech-logo.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./favicon-64.png"];
