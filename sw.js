const CACHE="beparytech-v69";
const RUNTIME="beparytech-v69-security-runtime";
const SHELL=["./","./index.html","./style.css?v=69","./app.js?v=69","./manifest.json?v=69","./beparytech-logo.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./favicon-64.png"];
