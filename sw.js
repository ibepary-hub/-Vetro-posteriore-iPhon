const CACHE="beparytech-v1084";
const RUNTIME="beparytech-v10841-security-runtime";
const SHELL=["./","./index.html","./style.css?v=1084","./app.js?v=1084","./manifest.json?v=108","./beparytech-logo.png","./icon-192.png","./icon-512.png","./apple-touch-icon.png","./favicon-64.png"];
